Name "ghpmc ${MAJORVERSION}.${MINORVERSION}.${BUILDVERSION}" # VERSION variables set through command line arguments
InstallDir "$InstDir"
OutFile "${OUTPUTFILE}" # set through command line arguments

# Links for "Add/Remove Programs"
!define HELPURL "https://github.com/happymadechain/go-happymadediuma/issues"
!define UPDATEURL "https://github.com/happymadechain/go-happymadediuma/releases"
!define ABOUTURL "https://github.com/happymadechain/go-happymadediuma#ethereum-go"
...
# Install ghpmc binary
Section "Ghpmc" GETH_IDX
  SetOutPath $INSTDIR
  file {{.Ghpmc}}

  # Create start menu launcher
  createDirectory "$SMPROGRAMS\${APPNAME}"
  createShortCut "$SMPROGRAMS\${APPNAME}\${APPNAME}.lnk" "$INSTDIR\ghpmc.exe" "--fast" "--cache=512"
  createShortCut "$SMPROGRAMS\${APPNAME}\Attach.lnk" "$INSTDIR\ghpmc.exe" "attach" "" ""
  ...
  # Firewall - add rules
  SimpleFC::AdvAddRule "Ghpmc incoming peers (TCP:33860)" ""  6 1 1 2147483647 1 "$INSTDIR\ghpmc.exe" "" "" "Ethereum" 33860 "" "" ""
  SimpleFC::AdvAddRule "Ghpmc outgoing peers (TCP:33860)" ""  6 2 1 2147483647 1 "$INSTDIR\ghpmc.exe" "" "" "Ethereum" "" 33860 "" ""
  SimpleFC::AdvAddRule "Ghpmc UDP discovery (UDP:33860)" "" 17 2 1 2147483647 1 "$INSTDIR\ghpmc.exe" "" "" "Ethereum" "" 33860 "" ""

  # Set default IPC endpoint (https://github.com/ethereum/EIPs/issues/147)
  ${EnvVarUpdate} $0 "ETHEREUM_SOCKET" "R" "HKLM" "\\.\pipe\ghpmc.ipc"
  ${EnvVarUpdate} $0 "ETHEREUM_SOCKET" "A" "HKLM" "\\.\pipe\ghpmc.ipc"
