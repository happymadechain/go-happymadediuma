...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "ghpmc.ipc", false, filepath.Join(os.TempDir(), "ghpmc.ipc")},
		{"data", "ghpmc.ipc", false, "data/ghpmc.ipc"},
		{"data", "./ghpmc.ipc", false, "./ghpmc.ipc"},
		{"data", "/ghpmc.ipc", false, "/ghpmc.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "ghpmc.ipc", true, `\\.\pipe\ghpmc.ipc`},
		{"data", "ghpmc.ipc", true, `\\.\pipe\ghpmc.ipc`},
		{"data", `\\.\pipe\ghpmc.ipc`, true, `\\.\pipe\ghpmc.ipc`},
	}
